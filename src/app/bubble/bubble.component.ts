...
export class BubbleComponent implements OnInit {
  ...
  @ViewChild('bubble', { static: false }) canvasEl: ElementRef;
  get bubble(): HTMLCanvasElement {
    return this.canvasEl && this.canvasEl.nativeElement;
  }
